...
public class ProtobufPatcher {
  ...
  /**
   * Makes protobuf version 3.6.0 compatible to libraries that still use protobuf 2.5.0.
   */
   ...
   * that were made private nested in protobuf 3.6.0 to be accessible by the old fully qualified name.
   *
